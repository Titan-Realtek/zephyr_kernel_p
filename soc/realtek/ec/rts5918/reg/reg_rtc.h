...
#ifndef ZEPHYR_SOC_REALTEK_RTS5918_REG_RTC_H
#define ZEPHYR_SOC_REALTEK_RTS5918_REG_RTC_H
...
#define RTC_CTRL1_AIE_Pos	   (5UL)
#define RTC_CTRL1_AIE_Msk	   BIT(RTC_CTRL1_AIE_Pos)
#define RTC_CTRL1_SETMODE_Pos  (7UL)
#define RTC_CTRL1_SETMODE_Msk  BIT(RTC_CTRL1_SETMODE_Pos)
/* CTRL2 */
#define RTC_CTRL2_AIF_Pos      (5UL)
#define RTC_CTRL2_AIF_Msk	   BIT(RTC_CTRL2_AIF_Pos)
/* WEEK */
#define RTC_WEEK_NUM_Pos       (0UL)
#define RTC_WEEK_NUM_Msk       GENMASK(7, 0)

#endif /* ZEPHYR_SOC_REALTEK_RTS5918_REG_RTC_H */
