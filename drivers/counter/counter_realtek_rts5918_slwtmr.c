...
#define DT_DRV_COMPAT realtek_rts5918_slwtimer
...
LOG_MODULE_REGISTER(counter_realtek_rts5918_slwtmr, CONFIG_COUNTER_LOG_LEVEL);
...
#define COUNTER_RTS5918_INIT(inst)                                                                 \
	...
	DEVICE_DT_INST_DEFINE(inst, counter_rts5918_init, NULL, &counter_rts5918_dev_data_##inst,  \
			      &counter_rts5918_dev_config_##inst, POST_KERNEL,                     \
